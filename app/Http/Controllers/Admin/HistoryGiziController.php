...
class HistoryGiziController extends Controller
{
    ...
    {
        $last = AnalystGizi::select('type', 'user_id', 'created_at')->orderBy('created_at', 'desc')->get();
        ...
        return view('admin.master-data.gizi.index', $data);
    }
    ...
    {
        $data['data'] = AnalystGizi::where('type', 'breakfast')->paginate(20);

        return view('admin.master-data.gizi.breakfast', $data);
    }

    public function launch()
    {
        $data['data'] = AnalystGizi::where('type', 'launch')->paginate(20);

        return view('admin.master-data.gizi.launch', $data);
    }

    public function dinner()
    {
        $data['data'] = AnalystGizi::where('type', 'dinner')->paginate(20);

        return view('admin.master-data.gizi.dinner', $data);
    }

    public function snack()
    {
        $data['data'] = AnalystGizi::where('type', 'snack')->paginate(20);

        return view('admin.master-data.gizi.snack', $data);
    }
}