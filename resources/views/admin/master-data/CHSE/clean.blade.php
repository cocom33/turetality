...
@section('breadcrumb', 'History Analisis Kebersihan')
        ...
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                ...
                <div class="flex gap-2 items-center">
                    <x-button-light color="blue" text='History Custom' :link="route('admin.history.chse.custom', 'clean')" />
                    <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i>Tambah' :link="route('admin.analisis-chse.clean')" />
                </div>
            </div>
                ...
                <div class="intro-y box p-5">
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.chse.export') }}">
                                @csrf
                                <input type="hidden" name="date" value="now">
                                <input type="hidden" name="type" value="clean">
                                <input type="hidden" name="name" value="kebersihan">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    ...
                                    <form id="submit" action="{{ route('admin.history.chse.export') }}" method="post">
                                        @csrf
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap">Checklist</th>
                            ...
                            <tbody>
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">{{ $item->user_id ? $item->user->name : 'Admin' }}</td>
                                        ...
                                        <td class="whitespace-nowrap">{{ $item->place }}</td>
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <x-button-modal type="modal-xl" id="modalc{{ $item->id }}" text="<i data-lucide='eye' width='18'></i>" color="blue">
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        @if ($item->number == 1)
                                                            <div class="text-base">Pertanyaan : Apakah Pihak Hotel menyediakan SOP Kebersihan Lingkungan Kerja</div>
                                                        @endif
                                                        @if ($item->number == 2)
                                                            <div class="text-base">Pertanyaan : Adanya penggolongan tempat sampah</div>
                                                        @endif
                                                        <h4 class="mt-2 text-base">{{ $item->check ? 'Ada' : 'Tidak Ada' }}</h4>
                                                    </div>
                                                    <div class="mt-5">
                                                        <h2 class="text-lg font-medium truncate mt-3">Lokasi</h2>
                                                        <h4 class="mt-2 text-base">{{ $item->place }}</h4>
                                                    </div>
                                                    <div class="mt-5">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body p-5 text-center">
                                                        ...
                                                        <form id="delete-{{ $item->id }}" action="{{ route('admin.history.chse.delete', $item->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
