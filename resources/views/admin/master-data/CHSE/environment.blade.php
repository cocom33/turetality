...
@section('breadcrumb', 'History Analisis Lingkungan')
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                ...
                <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i> Add' :link="route('admin.analisis-chse.environment')" />
            </div>
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.chse.export') }}">
                                ...
                                <input type="hidden" name="name" value="lingkungan">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="flex gap-2">
                                                ...
                                                />
                                                <x-button-modal type="modal-xl" id="modale{{ $item->id }}" text="<i data-lucide='eye' width='18'></i>" color="blue">
                                                    <div class="mt-5">
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        @if ($item->number == 1)
                                                            <div class="text-base">Pertanyaan : Kondisi suhu yang normal</div>
                                                        @endif
                                                        @if ($item->number == 2)
                                                            <div class="text-base">Pertanyaan : kondisi penerangan cukup</div>
                                                        @endif
