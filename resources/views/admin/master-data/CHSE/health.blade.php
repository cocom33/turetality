...
@section('breadcrumb', 'History Analisis Kesehatan')
        ...
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                ...
                <div class="flex gap-2 items-center">
                    <x-button-light color="blue" text='History Custom' :link="route('admin.history.chse.custom', 'health')" />
                    <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i>Tambah' :link="route('admin.analisis-chse.health')" />
                </div>
            </div>
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.chse.export') }}">
                                ...
                                <input type="hidden" name="name" value="kesehatan">
