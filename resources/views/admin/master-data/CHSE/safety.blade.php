        ...
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                ...
                <div class="flex gap-2 items-center">
                    <x-button-light color="blue" text='History custom' :link="route('admin.history.chse.custom', 'safety')" />
                    <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i>Tambah' :link="route('admin.analisis-chse.safety')" />
                </div>
            </div>
