        ...
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                <h2 class="text-lg font-medium truncate mr-5">
                    History Analisis Gizi Makan Malam
                </h2>
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.gizi.export') }}">
                                ...
                                <input type="hidden" name="name" value="makan-malam">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="flex gap-2">
                                                ...
                                                />
                                                <x-button-modal type="modal-xl" id="modald{{ $item->id }}" text="<i data-lucide='eye' width='18'></i>" color="blue">
                                                    <div class="mt-5">
