        ...
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                <h2 class="text-lg font-medium truncate mr-5">
                    History Analisis Gizi Makan Siang
                </h2>
                <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i>Tambah' :link="route('admin.analisis-gizi.morning')" />
            </div>
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.gizi.export') }}">
                                ...
                                <input type="hidden" name="type" value="launch">
                                <input type="hidden" name="name" value="makan-siang">
                            ...
                            <tbody>
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap"><x-long-text :text="$item->menu" /></td>
                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="flex gap-2">
                                                ...
                                                />
                                                <x-button-modal type="modal-xl" id="modall{{ $item->id }}" text="<i data-lucide='eye' width='18'></i>" color="blue">
                                                    <div class="mt-5">
