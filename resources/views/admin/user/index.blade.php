    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 mt-8">
            <div class="intro-y flex items-center justify-between h-10">
                ...
                <x-button-light color="blue" text='<i data-lucide="x" class="w-18 inline mr-3 rotate-45"></i>Tambah' :link="route('admin.users.create')" />
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="flex gap-2">
                                                <x-button-light color="blue" :link="route('admin.users.show', $item->id)"
                                                    text="<i data-lucide='eye' width='18'></i>"
                                                />
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body p-5 text-center">
                                                            <h2 class="text-lg font-medium truncate mt-3">Hapus Akun User?</h2>
