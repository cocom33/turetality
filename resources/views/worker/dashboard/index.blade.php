...
@push('addon-script')
    <script>
        function speak() {
            ...
            var ult = new SpeechSynthesisUtterance(test);
...
@section('content')
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="grid grid-cols-12 gap-6">
                {{-- <x-button-modal text="test" id="tesss" color="blue">
                    <x-form-input name="aa" placeholder="etset" label="test" />
                    <x-button-light text="cba" color="blue" attr="onclick=speak()" />
                </x-button-modal> --}}
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">
                            Summary Laporan Analisis CHSE
                        </h2>
                    </div>
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex justify-between items-center">
                                        <div class="text-xl font-medium leading-8">Lingkugan</div>
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-12">
                    <div class="intro-y flex items-center justify-between h-10">
                        ...
                        <x-button-light text="lihat semua" color="blue" :link="route('imt')" />
                    </div>
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center justify-between h-10">
                        ...
                        <x-button-light color="blue" text='lihat semua' :link="route('reports')" />
                    </div>
                    <div class="intro-y col-span-12 mt-5">
                        <div class="intro-y box p-5">
                            <div class="overflow-x-auto">
