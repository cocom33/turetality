...
@section('breadcrumb', 'History Analisis Keselamatan')

@section('content')
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 mt-8">
            <div class="intro-y flex flex-col md:flex-row md:items-center justify-between">
                <h2 class="text-lg font-medium truncate">
                    History Analisis Keselamatan
                </h2>
                <div class="flex gap-3 ml-auto mt-5 md:mt-0">
                    <x-button-light color="blue" text='Add Type 1' :link="route('analisis-chse.safety1')" />
                    <x-button-light color="blue" text='Add Type 2' :link="route('analisis-chse.safety2')" />
                </div>
            </div>
                    ...
                    <div class="flex justify-between items-center mb-5">
                        ...
                        {{-- <div class="flex gap-3">
                            ...
                            <form method="POST" action="{{ route('admin.history.chse.export') }}">
                                ...
                                <input type="hidden" name="name" value="Keselamatan">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="flex gap-2">
                                                ...
                                                />
                                                <x-button-modal type="modal-xl" id="modalchse{{ $item->id }}" text="<i data-lucide='eye' width='18'></i>" color="blue">
                                                    <div class="mt-5">
                                                        <h2 class="text-lg font-medium truncate mt-3 mb-2">Checklist</h2>
                                                        @if ($item->number == 1)
                                                            <div class="text-base">Pertanyaan : Adanya jaminan kesehatan bagi pekerja</div>
                                                        @endif
                                                        @if ($item->number == 2)
